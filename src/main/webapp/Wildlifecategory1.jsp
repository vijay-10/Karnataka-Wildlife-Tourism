...
<head>
    ...
    <style>
        ...
        .hero {
            position: relative;
            height: 70vh;
            background: url('https://wildtrails.in/wp-content/uploads/2015/10/Chinnar-Wildlife-Sanctuary.jpg') no-repeat center center/cover;
            display: flex;
...
<body>
    ...
    <div class="hero">
        <h1>Karnataka Wildlife Tourism</h1>
    </div>

    <!-- Destination Section -->
    <div class="container-fluid bg-light">
        <h2 class="section-title">Explore Wildlife Sanctuaries</h2>
        <p class="section-subtitle">Discover Karnataka's amazing natural wildlife destinations</p>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body text-center">
                        ...
                        <p class="card-text">Explore the natural beauty and wildlife of <%= s.getDname() %>.</p>
